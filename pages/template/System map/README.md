...
- The card header names the system under its political space, e.g. "UEE space" over "Stanton system".
- Asteroid belts draw as a speckled band at their orbital position, not a disc, since they're regions with no diameter to draw. A planet's rings draw the same way under it, alongside its moons; a ring orbiting a moon rather than a planet isn't drawn.
