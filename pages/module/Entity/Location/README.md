...
- The StarSystem and JumpPoint enrich bridges are mutually exclusive by construction: a record resolves to exactly one leaf, so a page never carries both `apiData.starsystem` and `apiData.celestialobject`.
