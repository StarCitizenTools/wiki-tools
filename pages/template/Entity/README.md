...
- `{{Entity}}` writes the entity's own infobox data: the page's SMW structured data, `SHORTDESC`, and its categories. None of the five sibling body templates below write any of that themselves.
