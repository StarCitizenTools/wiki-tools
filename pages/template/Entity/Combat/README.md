...
- An upstream fetch failure shows the warning "Couldn't load combat encounters."; a contract with no recorded encounter shows the placeholder "No combat encounters." Most contracts have none, so add this section only where the data exists.
