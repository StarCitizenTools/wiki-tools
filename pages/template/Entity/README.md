...
- `{{Entity}}` writes the entity's own infobox data: the page's structured data, `SHORTDESC`, and its categories. None of the six sibling body templates below write any of that themselves.
